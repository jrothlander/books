...
BOOL CNURBSPatchApplication::FillPatchBuffer()
{
	...
	pVertices[2].x = 0.0f;
	pVertices[2].z = 100.0f;
	pVertices[3].x = 100.0f;
	pVertices[3].z = 100.0f;
	pVertices[4].x = 100.0f;
	pVertices[4].z = 0.0f;
	pVertices[5].x = 100.0f;
	pVertices[5].z = -100.0f;
	pVertices[6].x = 0.0f;
	pVertices[6].z = -100.0f;
	pVertices[7].x = -100.0f;
	pVertices[7].z = -100.0f;
	pVertices[8].x = -100.0f;
	pVertices[8].z = 0.0f;

	for (long V = 0; V < NUM_V_POINTS; V++)
	{
		pVertices[NUM_U_POINTS + V].x = 250.0f;
		pVertices[NUM_U_POINTS + V].y = (float)V * 400.0f / (float)(NUM_V_POINTS - 1);
		pVertices[NUM_U_POINTS + V].z = 250.0f + ANIMATE(400.0f) * sin(pVertices[NUM_U_POINTS + V].y / 100.0f);
