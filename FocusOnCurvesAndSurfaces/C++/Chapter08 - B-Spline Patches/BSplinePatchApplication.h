...
#define NUM_PATCH_VERTICES 15

#define NUM_U_POINTS 5
#define NUM_V_POINTS 5

#define PATCH_ORDER_U  3
#define PATCH_ORDER_V  3

class CBSplinePatchApplication : public CPatchApplication  
{
public:
	...
	CBSplinePatchApplication();
	virtual ~CBSplinePatchApplication();
	...
	float        m_BasisFunctionsU[NUM_PATCH_VERTICES][NUM_U_POINTS][PATCH_ORDER_U];
	float        m_DerivativeBasisU[NUM_PATCH_VERTICES][NUM_U_POINTS][PATCH_ORDER_U];

	float        m_BasisFunctionsV[NUM_PATCH_VERTICES][NUM_V_POINTS][PATCH_ORDER_V];
	float        m_DerivativeBasisV[NUM_PATCH_VERTICES][NUM_V_POINTS][PATCH_ORDER_V];
