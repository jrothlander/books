...
BOOL CPatchApplication::HandleMessage(MSG *pMessage)
{
	...
	D3DXMatrixLookAtLH(&m_ViewMatrix,
		               &D3DXVECTOR3(250.0f + 900.0f * cos(m_ViewerAngle),
		                            m_ViewerHeight,
						            250.0f + 900.0f * sin(m_ViewerAngle)),
...
HRESULT CPatchApplication::SetupDevice()
{
	...
	D3DXMatrixPerspectiveFovLH(&m_Projection, D3DX_PI / 4.0f, 1.0f, 1.0f, 3000.0f);
