...
const char* g_szApplicationName = "Bouncing Balls - with Dialog";
...
//------------------------------------------------------------------------
INT_PTR CALLBACK OptionsDialogProc(HWND   hwnd,
    UINT   msg,
    WPARAM wParam,
    LPARAM lParam)
{
    ...
    LPARAM lParam)
{
    ...
    case WM_COMMAND:
    {
        ...
        case ID_ABOUT_ABOUT:
        {
            DialogBox(hInstance, MAKEINTRESOURCE(IDD_DIALOGBAR1), hwnd, AboutDialogProc);
        }
        break;

        case ID_BALL_OPTIONS:
        {
            DialogBox(hInstance, MAKEINTRESOURCE(IDD_DIALOGBAR), hwnd, OptionsDialogProc);
        }
        break;
