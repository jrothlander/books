...
const char* szApplicationName = "Chapter5 - Our Salesman Gets Smarter";
const char* szWindowClassName = "TSPclass";

const char* szMutationOperators[6] = { "Exchange Mutation",
...
const char* szCrossoverOperators[4] = { "Partially Matched Crossover",
