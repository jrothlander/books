...
In my opinion, software development book have become pretty bad the past few decades. Today, what is missing from most modern game dev books is depth, expert details, tricks of the trade, things that come from a depth of knowledge and experiance from being in the trenches for decades. Many modern books on game dev are published by college students and hobbiest with little experiance. The books read more like online blogs from someone trying to learn the technology while documenting the process. They are riddled with errors, poor code, and often the author fails to understand important concepts such as gametime, game AI, matrices, etc. Without the depth of experiance, the author cannot offer expert insights, which is what I am really look for when purchasing a book. And all of that, and for a price between $35 to $75. 
